from eGPS4Py import ClusterTree

# Example of a minimalistic numerical matrix. It is encoded as a text
# string for convenience, but it usually be loaded from a text file.
matrix = """
...
# partition, which is computed as the average of all vectors under
# the given node. NOTE: This is a mean profile
...
# https://etetoolkit.org/docs/latest/tutorial/tutorial_clustering.html