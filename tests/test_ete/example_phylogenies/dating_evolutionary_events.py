...
# detecting the species code of leaves (three first letters in the node
...
t = PhyloTree(nw)
print("Original tree:")
print(t.get_ascii(compact=False,show_internal=True, attributes=["name","dist"]))
#
#             /-Dme_001
#   /--------|
#  |          \-Dme_002
...
# Normally, the age is time past from here, more greater more old
species2age = {
...
# We can translate each number to its corresponding taxonomic number
age2name = {
  1:"hominids",
  2:"primates",
  3:"mammals",
...
#https://etetoolkit.org/docs/latest/tutorial/tutorial_phylogeny.html