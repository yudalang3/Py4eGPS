...
#
# fseqs is a function that, given a list of sequences, returns only those from human and mouse
...
# algorithm has labeled the tree nodes according to the
# predictions. We can use such labels as normal node features.
