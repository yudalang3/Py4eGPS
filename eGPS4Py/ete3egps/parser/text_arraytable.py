...
def read_arraytable(matrix_file, mtype="float", arraytable_object = None):
    ...
    ### 示例输入文件内容（`matrix.txt`）：
    #NAMES gene1 gene2 gene3 sample1 1.2 3.4 5.6 sample2 2.3 4.5 6.7 sample3 3.4 5.6 7.8
    ### Python 代码示例：
    python from eGPS4Py.ete3egps.parser.text_arraytable import read_arraytable
读取矩阵文件
array_table = read_arraytable("matrix.txt", mtype="float")
打印解析后的数据
print("行名称:", array_table.rowNames) print("列名称:", array_table.colNames) print("矩阵数据:\n", array_table.get_matrix())
    """
